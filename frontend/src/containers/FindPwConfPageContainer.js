...
class FindPwConfPageContainer extends Component {
    ...
    clickToSubmit = async (e) => {
        ...
        if (code.length == 0) {
            ...
            await this.props.history.push(`/find_password/success`);
...
export default connect()(withRouter(FindPwConfPageContainer));